...
import { ReadingListPage } from './pages/reader/ReadingListPage';
...
import { FeesPage as ReaderFeesPage } from './pages/reader/FeesPage';
...
export const router = createBrowserRouter([
  ...
  {
    element: <AppWrapper><ResetPasswordPage /></AppWrapper>,
    path: '/reset-password',
  },
  {
    path: '/',
    ...
    children: [
      ...
      // Reader
      {
        ...
        children: [
          ...
          { path: 'reservations', element: <ReaderReservationsPage /> },
          { path: 'fees', element: <ReaderFeesPage /> },
        ],
      },
    ],
  },
