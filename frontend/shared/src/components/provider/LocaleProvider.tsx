...
// Ánh xạ mã ngôn ngữ → Antd `Locale`. Dùng đúng type để ConfigProvider nhận
// prop hợp lệ (trước đây để `unknown` gây lỗi TS ở build time).
const localeMappings: Record<string, Locale> = {
  en: enUS,
  vi: viVN,
  fr: frFR,
};
