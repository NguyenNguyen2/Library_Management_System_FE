...
> {
  ...
  /** Custom delete confirmation title (defaults to translation key 'delete_title') */
  deleteConfirmTitle?: ReactNode;
  /** Custom delete confirmation content (defaults to translation key 'delete_content') */
      ...
      content: (
        <div className="text-center">
          ...
          <div className="mt-3 font-bold text-xl">
            {deleteConfirmTitle || t('delete_title')}
          </div>
          <div className="text-sm">{deleteConfirmContent || t('delete_content')}</div>
        </div>
      ),
      okText: t('delete'),
        ...
        <Flex vertical gap={24} align="stretch">
          ...
          {hasPageHeader && (
            <Flex justify="space-between" align="center">
              <div>
                <h1 className="text-[30px] font-bold text-navyDark leading-[36px] m-0">
                  {pageTitle}
                </h1>
                {pageSubtitle && (
                  <p className="text-[16px] text-grayDark leading-[24px] mt-1 m-0">
                    {pageSubtitle}
                  </p>
                )}
              </div>
          ...
          <Card className="filter-table-card">
            <div className="filter-table-header flex flex-col gap-4 mb-4">
              ...
              <Flex justify="space-between" align="center">
                ...
                {/* Only show create button inside card if NO page header */}
                {!hasPageHeader && (
                  <Flex align="center" gap={12}>
                    {renderCreateButton()}
                    {exportInfo?.type && exportMutation && (
