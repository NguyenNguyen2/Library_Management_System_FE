  ...
  return (
    <Select
      ...
      onChange={(selectedValue) => {
        ...
        // Multi-select: selectedValue is an array of { value, label }
        if (Array.isArray(selectedValue)) {
          const normalized = selectedValue.map((item: LabelInValue) => ({
            value: item?.value,
            label: item?.label ?? '',
          }));
          onChange?.(normalized);
        ...
        // Single-select: selectedValue is a single { value, label }
